...
<head>
    ...
    <link rel="stylesheet" href="//at.alicdn.com/t/font_2274543_xeo1fbm6a4.css">
    <link rel="stylesheet" href="//at.alicdn.com/t/font_2274543_eok450usuk9.css">
    <link rel="stylesheet" href="//at.alicdn.com/t/font_2274543_3afbglowi8q.css">
    <link rel="stylesheet" href="//at.alicdn.com/t/font_2274543_j7j14guwqzi.css">
</head>
<body>
...
<%--            输入界面--%>
            ...
            <div class="messages-box">
                <textarea class="messages-content" name="" id="contest_test " cols="30" rows="10"></textarea>
                <select id="mySelect">
        ...
        <div class="Content-Other">
            <form action="" method="post" class="form-userInfo">
                <p>
                    ...
                    <label>
                        <span>个人介绍：</span>
                        <textarea id="evaluate" name="evaluate" placeholder="输入您的个人介绍！"></textarea>
                    </label>
                    <label>
                        <input type="button" class="button" value="保存信息" style="position: relative;margin-left: 140px">
                    </label>
